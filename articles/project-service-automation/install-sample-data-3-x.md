...
4. Jika nama lengkap pengguna "Spencer Low" Anda memiliki ID pengguna yang berbeda dari **"spencerl"**, maka Anda harus memperbarui file tambahan. Buka **DemoDataPreImportConfig.xml** file, dan kemudian menemukan **userstocreateandconfigure** tag. Pembaruan **\<login\>** tag dengan loginId (peka huruf besar/kecil). 

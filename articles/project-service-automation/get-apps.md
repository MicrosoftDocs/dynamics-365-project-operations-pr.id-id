...
Jika Anda ingin memasukkan waktu dan biaya di perangkat seluler, [Dapatkan dan instal Dynamics 365 for phones and tablets](../mobile-app/dynamics-365-phones-tablets-users-guide.md).  
  
 Anda juga dapat menggunakan aplikasi Project Finder Mobile di telepon Anda untuk menemukan sebuah proyek baru untuk dikerjakan dan melamarnya. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Temukan proyek berikutnya dengan app Project Finder Mobile](../project-service/find-next-project-finder-mobile-app.md) 

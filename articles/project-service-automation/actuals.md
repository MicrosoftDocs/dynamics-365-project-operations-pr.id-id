...
## <a name="using-journals-to-record-costs"></a>Menggunakan jurnal untuk mencatat biaya

Dalam PSA, jurnal memungkinkan Anda merekam biaya atau pendapatan dalam materi, biaya, waktu, pengeluaran, atau kelas transaksi pajak. Jurnal memiliki header, baris, dan tindakan **konfirmasi**. Berikut adalah beberapa skenario di mana Anda dapat menggunakan jurnal:

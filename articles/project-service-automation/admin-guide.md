...
- [Konfigurasi Frekuensi Faktur](set-up-invoice-frequencies.md)
- [Konfigurasi Kategori Transaksi](configure-transaction-categories.md)
- [Konfigurasi Kategori Pengeluaran](configure-expense-categories.md)
...
### <a name="see-also"></a>Lihat Juga  
 ...
 [Panduan Manajer akun](../project-service/account-manager-guide.md) [panduan manajer proyek](../project-service/project-manager-guide.md)   

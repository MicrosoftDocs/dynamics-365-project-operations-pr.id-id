...
description: Artikel ini menyediakan informasi tentang memutakhirkan struktur rincian kerja dari Project Service Automation 2.x ke 3.x.
ms.custom:
...
Artikel ini menyediakan informasi tentang memutakhirkan struktur rincian kerja dari Project Service Automation 2.x ke 3.x. Artikel ini mendefinisikan status sehat proyek di Project Service Automation (PSA) yang diperlukan untuk peningkatan yang sukses. Ada juga informasi tentang kondisi pemblokiran umum yang akan menyebabkan peningkatan gagal. Untuk informasi lebih lanjut tentang mendefinisikan tugas proyek dan fungsinya dalam jadwal proyek, lihat [jadwal proyek](project-creating.md).

...
Di Dynamics 365 Project Service Automation, ada dua jenis kuotasi: kuotasi proyek dan kuotasi penjualan. Kedua jenis berbeda dengan cara berikut:

- Pada kuotasi penjualan, hanya ada satu kisi untuk item baris. Pada kuotasi proyek, ada dua kisi untuk item baris: satu untuk baris proyek dan satu untuk lini produk.
...
- **Berbasis proyek** - jumlah (nilai yang dikutip) ditentukan setelah Anda memperkirakan berapa banyak pekerjaan yang diperlukan. Anda dapat memperkirakan pekerjaan di tingkat tinggi, atau Anda dapat memperkirakan secara langsung sebagai rincian baris di bawah setiap baris kuotasi. Terakhir, Anda dapat memperkirakan pekerjaan berdasarkan perkiraan menyeluruh, menggunakan proyek dan rencana proyek. Baris kuotasi berbasis proyek hanya ditemukan dalam kuotasi berbasis proyek yang dibuat menggunakan Project Service Automation. Baris kuotasi jenis ini adalah formulir kustom baris kuotasi tulis yang tersedia dalam Microsoft Dynamics 365 Sales.
- **Berbasis produk** – jumlah (nilai yang dikutip) ditentukan berdasarkan kuantitas unit yang terjual dan harga penjualan unit produk. Produk pada baris berbasis produk dapat berasal dari Katalog Produk dalam Sales, atau dapat berupa produk yang Anda tentukan. Baris kuotasi jenis ini juga tersedia pada kuotasi berbasis proyek yang dibuat menggunakan PSA.

Jumlah pada kuotasi adalah total di seluruh baris berbasis produk dan baris berbasis proyek.

> [!NOTE]
> Kuotasi dan baris kuotasi tidak diperlukan di PSA. Anda dapat memulai proses proyek dengan kontrak proyek (proyek yang dijual). Namun, peluang selalu diperlukan, terlepas dari Apakah Anda mulai dengan kuotasi atau kontrak proyek.

## <a name="project-based-quote-lines"></a>Baris kuotasi berbasis proyek

Baris kuotasi berbasis proyek dalam PSA memiliki metode penagihan berikut:
...
PSA mendukung ketiga jenis jadwal faktur untuk baris kuotasi harga tetap.
...
- **Tonggak waktu** -klasifikasi ini digunakan oleh logika penagihan harga tetap dalam PSA.
...
Bidang **jenis penagihan** menentukan konsep ketertagihan di PSA. Ini adalah rangkaian pilihan yang memiliki nilai yang mungkin berikut:
...
Jadwal faktur adalah rangkaian tanggal saat pemfakturan untuk proyek terjadi. Anda dapat memilih untuk membuat jadwal faktur pada baris kuotasi di PSA. Setiap baris kuotasi dapat memiliki jadwal faktur tersendiri. Untuk membuat jadwal faktur, Anda harus menyediakan nilai atribut berikut:

- Tanggal mulai penagihan 
- Tanggal pengiriman yang menunjukkan tanggal berakhir penagihan pada proyek
- Frekuensi faktur

PSA menggunakan tiga nilai atribut ini untuk membuat rangkaian tanggal tentatif untuk membuat faktur.

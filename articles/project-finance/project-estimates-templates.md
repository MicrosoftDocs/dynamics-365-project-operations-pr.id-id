...
- Jika Anda membuat template baru, Anda harus menambahkan kolom ini. Di Power Query, pilih **Tambah kolom kondisional**, dan masukkan nama untuk kolom baru, misalnya **ModelID**. Masukkan kondisi untuk kolom, di mana, jika tugas proyek tidak null, \<masukkan ID model perkiraan\>; jika lainnya, null.
...
[![Pemetaan template](./media/ProjectHourEstimatesMapping.jpg)](./media/ProjectHourEstimatesMapping.jpg)
...
- Jika Anda membuat template baru, Anda harus menambahkan kolom ini. Di Power Query, pilih **Tambah kolom kondisional**, dan masukkan nama untuk kolom baru, misalnya **ModelID**. Masukkan kondisi untuk kolom, di mana, jika ID baris Estimasi tidak null, \<masukkan ID model perkiraan\>; jika lainnya, null.
...
[![Pemetaan template](./media/ExpenseEstimateTransactionRelationshipsMapping.jpg)](./media/ExpenseEstimateTransactionRelationshipsMapping.jpg)

[![Pemetaan template](./media/ExpenseEstimatesMapping.jpg)](./media/ExpenseEstimatesMapping.jpg)
